...
"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 grid-flow-row-3 gap-4 mb-8 md:grid-cols-3 md:grid-rows-2">
              <ButtonCalc className="bg-darkGreen text-white">5%</ButtonCalc>
              <ButtonCalc className="bg-darkGreen  text-white">10%</ButtonCalc>
              <ButtonCalc className="bg-greenBtn text-darkGreen">
                15%
              </ButtonCalc>
              <ButtonCalc className="bg-darkGreen  text-white">25%</ButtonCalc>
              <ButtonCalc className="bg-darkGreen  text-white">50%</ButtonCalc>
              <ButtonCalc className="bg-displayCalc text-blackGreen">
                custom
              </ButtonCalc>
            </div>
          </div>
        ...
        <div className="md:w-1/2 ">
          <Tips_calculator_output_data></Tips_calculator_output_data>
        </div>
      </div>
    </div>
  );
