  ...
  return (
    <div>
      <div className="max-w-screen-xl rounded-lg bg-black mx-auto xl:w-4/5 xl:mt-60 xl:mx-auto -ml-5 -mr-5 md:ml-0 md:mr-0 md:pt-24 md:pb-4  md:mt-24">
        <div className="flex flex-col relative items-center md:flex-row	 xl:w-3/4 m-auto ">
          ...
          <div className="absolute top-0  w-72  md:-top-24 md:left-72 xl:-mt-14  xl:w-80  z-0 xl:-ml-20 ">
            <img src={patern2} alt="patern2" />
          </div>

          <OrangeBox>
            <div className="text-2xl pb-5 md:pb-3 xl:pb10 xl:text-4xl font-bold ">
              Premium EQ
            </div>
            ...
            <div className="flex flex-col">
              <button className="bg-black color-white rounded-lg  pb-4 pt-4  mb-4 text-lg text-bold hover:bg-teal-300	">
                <svg
              ...
              <button className="bg-white text-black rounded-lg pb-4 pt-4 text-lg text-bold mb-3 hover:bg-orange-300		">
                <svg
                  className="inline mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
